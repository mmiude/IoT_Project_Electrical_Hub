...
{   
    ...
    case EZB_ZDO_SIGNAL_DEVICE_ANNCE: { // TODO: how to forward short_addr to coordinator class? 
    ...
    case EZB_ZDO_SIGNAL_LEAVE_INDICATION: { // TODO: how to forward short_addr to coordinator class? 
